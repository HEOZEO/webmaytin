...
const shimmer =
  'relative overflow-hidden bg-neutral-900/40 before:absolute before:inset-0 before:translate-x-[-100%] before:bg-gradient-to-r before:from-transparent before:via-white/5 before:to-transparent before:animate-[shimmer_1.4s_infinite]';
...
export function ProductCardSkeleton() {
  return (
    <div className="rounded-none clip-path-rog border border-neutral-800 bg-black/50 p-4" aria-label="Đang tải sản phẩm">
      <ShimmerDiv className="aspect-[4/3] w-full rounded-none clip-path-rog mb-4" />
...
export function ProductDetailSkeleton() {
  return (
    <div className="grid grid-cols-1 gap-8 md:grid-cols-2" role="status" aria-live="polite">
      <div>
        <ShimmerDiv className="aspect-square w-full rounded-none clip-path-rog" />
...
export function CartItemSkeleton() {
  return (
    <div className="flex gap-4 rounded-none clip-path-rog border border-neutral-800 bg-black/50 p-4" aria-label="Đang tải sản phẩm trong giỏ">
...
export function BannerSkeleton() {
  return (
    <div
      className="relative w-full aspect-[16/7] md:aspect-[21/9] rounded-none clip-path-rog overflow-hidden"
      role="status"
      aria-live="polite"
    >
      <ShimmerDiv className="absolute inset-0 rounded-none clip-path-rog" />
  ...
  return (
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-3" role="status" aria-live="polite">
      ...
      <div className="space-y-3">
        ...
        <ShimmerDiv className="h-40 w-full rounded-none clip-path-rog" />
      </div>
